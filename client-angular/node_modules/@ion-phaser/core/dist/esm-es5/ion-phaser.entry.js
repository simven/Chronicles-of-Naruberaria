...
import { r as registerInstance, g as getElement } from './core-58ca22c8.js';
var IonPhaser = /** @class */ (function () {
    function class_1(hostRef) {
        ...
        this.initializeGame = function (game) {
            if (game === void 0) { game = _this.game; }
            if (!game)
                return;
            if (game.instance) {
                throw new Error("A Phaser game already exist");
            }
            game.parent = game.parent || _this.el;
            game.instance = new Phaser.Game(game);
        };
    }
    class_1.prototype.onGameChange = function (game) {
        if (this.initialize && !this.getGameInstance()) {
            this.initializeGame(game);
        }
    };
    class_1.prototype.onInitialize = function (initialize) {
    ...
    class_1.prototype.getInstance = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Promise.resolve(this.getGameInstance())];
            });
        });
    };
    /**
    ...
    class_1.prototype.getGameInstance = function () {
    ...
    Object.defineProperty(class_1, "style", {
        get: function () { return "ion-phaser{display:block}"; },
        enumerable: true,
        configurable: true
    });
    return class_1;
